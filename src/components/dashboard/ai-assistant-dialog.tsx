    ...
    try {
      ...
      if (category && !isNaN(amount)) {
        ...
        toast({
          ...
          title: "Uh oh!",
          description:
            "The AI could not understand your request. Please try rephrasing it.",
        });
      }
    } catch (error) {
      console.error(error);
              ...
              >
                <div className="rounded-lg border bg-card text-card-foreground p-4 space-y-2">
                  ...
                  <div className="flex justify-between items-center">
                    ...
                    <Badge
                      variant={
                        suggestion.type === "income" ? "default" : "secondary"
                      }
                    >
                      {suggestion.type}
                    </Badge>
                  ...
                  <p className="text-sm text-muted-foreground pt-2">
                    <strong>Original:</strong> {form.getValues("description")}
                  </p>
                </div>
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      >
                        <FormControl>
                          <SelectTrigger>
                            <SelectValue placeholder="Select a money source" />
                          </SelectTrigger>
                        </FormControl>
                        <SelectContent>
